                    ...
                    FormValidate: {
                        ...
                        Format: {
                          Value: /^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z0-9]+$/,
                            Message: "<dl>邮件格式不正确</dl><dd></dd>"
                        }
                    },
					
					  Message: {
						CssClass: {
                       		Show: "Error",   //在页面显示的情况下
                       		Success:"success", //验证成功时的cssClass
                       		Error: "Error",  //验证失败时
                        	Focus: "Focus" //获得焦点时
                    	},
						...
						Text: {
                            Show: "",
                            Success: "",
                            Error: '<dl>邮箱不能为空</dl><dd></dd>',
                            Focus: "<dl>请输入有效电子邮箱，用于沙子网的通行证</dl><dt></dt>"
                        },
				...
				$("#pname").SetValidateSettings({
                    FormValidate: {
                        Empty: {
						 ...
						 MinLength: {
                            Value: 2,
                            Message: "<dl>名称过短！</dl><dd></dd>"
                        },
						  MaxLength: {
                            Value: 256,
                            Message: "<dl>名称过长！</dl><dd></dd>"
                        },
                        Format: {
                            Value: /^(?!\d{4,20}$)[^\n]{4,20}$/ ,
						    Message: "<dl>名称不能全是数字，名称由3^16位数的汉字、字母线组成！</dl><dd></dd>"
                        }
                    },
                    ...
                    Message: {
					    ...
					    Text: {
                            Show: "",
                            Success: "",
                            Error: "<dl>名称不能为空！</dl><dd></dd>",
                            Focus: "<dl>名称不能全是数字！</dl><dt></dt>"
                        },
                        MessageSpaceHolderID: "Tippname"
                    }
                });
			
			
			 $("#pword").SetValidateSettings({
                    FormValidate: {
                        Empty: {
                            Value: true
                        },
						 ...
						 MinLength: {
                            Value: 6,
                            Message: "<dl>密码提示答案过短！</dl><dd></dd>"
                        },
						
						  MaxLength: {
                            Value: 20,
                            Message: "<dl>密码提示答案过长！</dl><dd></dd>"
                        }
				     },
                    Message: {
					    CssClass: {
                        ...
                        Text: {
                            Show: "",
                            Success: "",
                            Error: "<dl>登陆密码不能为空！</dl><dd></dd>",
                            Focus: "<dl>密码需由6-16个字符（数字、字母、下划线）组成，区分大小写；不能使用重复、连续的字母、数字或下划线！</dl><dt></dt>"
                        },
                        MessageSpaceHolderID: "Tippword"
                    }
                });
				  
                $("#cpword").SetValidateSettings({
                    FormValidate: {
                        Empty: {
                            Value: true
                        },
                    ...
                    Message: {
                        ...
                        Text: {
                            Show: "",
                            Success: "",
                            Error: "<dl>确认密码必须输入</dl><dd></dd>",
                            Focus: "<dl>密码需由6-16个字符（数字、字母、下划线）组成，区分大小写；不能使用重复、连续的字母、数字或下划线！</dl><dt></dt>"
                        },
                        MessageSpaceHolderID: "Tipcpword"
                    }
                });	
