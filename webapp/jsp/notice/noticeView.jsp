		...
		<tr>
			<td class="newdqwz"><span class="font_navigate">您所在的位置：</span><span
				class="font_navigate">首页</span> <span class="font_navigate">&gt;</span><span
						class="font_navigate">新闻公告浏览</span></td>
		</tr>
	</tbody>
</table>
				...
				<div>
					<table class="table" id="GridView1"
						...
						<tbody>
							<tr align="center">
								<td align="center"><a
									href="">${requestScope.notice.title }</a>
								</td>
							</tr>
							<tr align="center">
								<td style="color: Black; width: 120px;"><fmt:formatDate value="${requestScope.notice.updatetime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							</tr>
							<tr align="center">
								<td style="color: Black; ">${requestScope.notice.content }</td>
							</tr>
						</tbody>
					</table>
				</div>
